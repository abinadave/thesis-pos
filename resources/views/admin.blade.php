...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class="dropdown"><a title="" href="{{ url('/logout') }}"><i class="icon icon-share-alt"></i> <span class="text">Logout</span></a></li>
  </ul>
</div>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-file"></i> Addons/a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-bar-chart"></i> <span>Reports</span> <span class="label label-important">2</span></a>
      <ul>
        <li><a v-link="{ name: 'reports-receiving'  }"><i class="icon icon-plus"></i>&nbsp;&nbsp;&nbsp; Incoming</a></li>
